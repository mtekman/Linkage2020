...
** Mystery of Inconsistent Markers
  ...
  But then the mystery of why allegro throws an inconsistent marker error for the alleles I examined still remains. I now believe it is likely to do with how allegro is configured, since it is trying to interpret the X genotypes as autosomal (where you would indeed expect 1 allele to come from the father).
