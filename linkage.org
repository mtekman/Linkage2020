                                                    ...
                                                    (let* ((line (readline))
                                                      ...
                                                      (unless (member marker unwanted)
                                                        (with-current-buffer newbuff
                                                          (insert line))))))))
       (let ((unwanted nil)
             (oldgenos (find-file-noselect "/ssh:tetris@132.230.153.85:/home/tetris/work/jobs_for_people/robert/118_canspanbrit/02_second/genotypes"))
             (newgenos (find-file-noselect "/home/tetris/work/linkage/third/genotypes"))
             (oldmaf (find-file-noselect "/ssh:tetris@132.230.153.85:/home/tetris/work/jobs_for_people/robert/118_canspanbrit/02_second/maf.txt"))
             (newmaf (find-file-noselect "/home/tetris/work/linkage/third/maf.txt")))
         ;; Read unwanted markers
         (with-current-buffer (find-file-noselect "/home/tetris/work/linkage/second/inconsistent.X.txt")
           (goto-char (point-min))
