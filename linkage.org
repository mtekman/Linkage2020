...
* Run 2
  ...
  =bitscore.py= computed that the largest family (1183) has 18 bits. I ran out of storage on my work machine so I moved to an external hd.
  ...
  Let's fill in the XY/XX with the genotypes
...
*** GRR notes
    ...
    Some things to note, in family 1183 - individual 2030 and 2034 are labelled as sister-brother, but the IBS relationship diagram seems to suggest that they might actually be mother-son! 

    Similarly, in family 1181 -- individual 57 and 97 are said to be father-son, but the IBS relationship diagram seems to suggest they might actually be brother-brother. This is a strange observation, since 57 comes from outside of the family, and yet there is a stronger familial tie between father-son than the mother-son. 

    Possible explanations are that 35 is not actually the mother, in which 97's mutation comes from outside of the family. 
